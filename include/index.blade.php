        ...
        <div class="container-fluid px-0">
            <div class="d-flex justify-content-between w-100" id="navbarSupportedContent">
                <div class="d-flex align-items-center">
                    ...
                    <div class="py-4">
                        <div class="dropdown">
                            <button class="btn btn-gray-800 d-inline-flex align-items-center dropdown-toggle me-2"
                                ...
                                <a href="#" class="list-group-item list-group-item-action border-bottom">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col ms-2 ps-0">
                                            ...
                                            <p class="font-small mb-0 mt-1">Added you to an event "Project stand-up"
                                ...
                                <a href="#" class="list-group-item list-group-item-action border-bottom">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col ms-2 ps-0">
                                            ...
                                            <p class="font-small mb-0 mt-1">You've been assigned a task for "Awesome new
                                                project".</p>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <a href="#" class="list-group-item list-group-item-action border-bottom">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col ms-2 ps-0">
                                            ...
                                            <p class="font-small mb-0 mt-1">New message: "We need to improve the UI/UX
    ...
    <div class="row">
                    ...
                    <div class="row d-block d-xl-flex align-items-center">
                        ...
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 mb-0 text-gray-400">All User</h2>
                                <h3 class="fw-extrabold mb-2">345k</h3>
                            </div>
                            <small class="d-flex align-items-center text-gray-500">
                                Feb 1 - Apr 1,
                                <svg class="icon icon-xxs me-1 ms-2 text-gray-500" fill="currentColor"
                                    viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            ...
                            <div class="d-sm-none">
                                <h2 class="fw-extrabold h5">Library</h2>
                                <h3 class="mb-1">$43,594</h3>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 mb-0 text-gray-400">Library</h2>
        ...
        <div class="col-12 mb-4">
            <div class="card border-0 bg-yellow-100 shadow">
                <div class="card-header d-sm-flex align-items-center flex-0 flex-row">
                    <div class="d-block mb-sm-0 mb-3">
                        <div class="fs-5 fw-normal mb-2">Total Library</div>
                        <h2 class="fs-3 fw-extrabold">%90</h2>
    ...
    <div class="row">
        ...
        <div class="col-12 col-xl-4">
            <div class="col-12 mb-4 px-0">
                <div class="card border-0 shadow">
                    <div class="card-header d-flex align-items-center flex-0 border-bottom flex-row">
                        <div class="d-block">
                        ...
                        <div class="d-block ms-auto">
                            <div class="d-flex align-items-center mb-2 text-end">
                                <span class="dot rounded-circle me-2 bg-gray-800"></span>
